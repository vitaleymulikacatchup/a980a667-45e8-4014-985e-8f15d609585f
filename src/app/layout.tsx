...
export const metadata: Metadata = {
  title: "Azure Grand Hotel - Luxury 5-Star Accommodations",
  description: "Experience exceptional luxury at Azure Grand Hotel. Premium rooms, world-class amenities, Michelin-starred dining, and personalized service in the heart of the city.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, fine dining, spa, business travel, city center hotel",
  ...
  openGraph: {
    title: "Azure Grand Hotel - Luxury 5-Star Accommodations",
    description: "Experience exceptional luxury at Azure Grand Hotel with premium rooms, world-class amenities, and personalized service.",
    url: "https://azuregrandhotel.com",
    ...
    images: [{
      ...
      alt: "Azure Grand Hotel elegant exterior with modern architecture"
    }],
    type: "website"
  },
  twitter: {
